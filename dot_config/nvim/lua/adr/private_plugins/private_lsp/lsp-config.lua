return {
	...
	config = function()
		...
		local on_attach = function(client, bufnr)
			...
			keymap.set("n", "<C-e>", vim.diagnostic.goto_prev, opts) -- jump to previous diagnostic in buffer

			opts.desc = "Go to next diagnostic"
			keymap.set("n", "<C-E>", vim.diagnostic.goto_next, opts) -- jump to next diagnostic in buffer
		...
		-- configure go server
		-- https://www.youtube.com/watch?v=i04sSQjd-qo&t=217s
